/**
 * Ściana medali wariantu E — karty imprez z medalami i medium (zdjęcie lub
...
import { videoById, type VideoItem } from "@/data/page-e/media"
...
export const medalCards: MedalCard[] = [
  ...
  },
  {
    ...
    media: {
      kind: "poster",
      src: videoById("video-lublin-braz").poster,
      alt: "Barbara Leśniewska z brązowym medalem mistrzostw Europy na basenie 25 m w Lublinie",
    },
    milestone: lublin,
    videos: [videoById("video-lublin-braz"), videoById("video-lublin-medal")],
  },
  {
    key: "skopje",
