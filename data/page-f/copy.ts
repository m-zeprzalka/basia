/**
 * Wariant F — „Fotofinisz". Treści krótkie, do składu wersalikami; liczby
 * niosą emocję, słowa tylko je podpisują. Terminologia jak w D/E:
 * „mistrzostwa Europy juniorów", „mistrzyni Europy juniorów",
 * „mistrzostwa Polski seniorów", „seniorski rekord Polski".
 */
...
export const menuF = [
  ...
  { index: 3, id: "medale", label: "Medale", hint: "11 medali · 4 imprezy" },
  {
    ...
    id: "paryz",
    label: "Paryż 2026",
    hint: "dwa finały wśród seniorów",
  },
...
export const heroF = {
  ...
  /** Trzy krótkie linie pod nazwiskiem — czytają się jak napisy z transmisji. */
  lines: [
  ...
  scroll: "Przewiń",
  /** Taśma składana wersalikami ręcznie — jednostka „s" ma zostać mała. */
  marquee: [
...
export const resultF = {
  ...
  replay: {
    ...
    finishNote:
      "Fotofinisz: ostatnie 1,5 s w powiększeniu — 0,32 s to szerokość dłoni.",
    gapLabel: "0,32 s",
  ...
  facts: [
    ...
    {
      value: "3",
      label: "rekordy Polski jednym wynikiem: 16-, 17- i 18-latek",
    },
  ],
} as const
...
export const medalsF = {
  ...
  recordsRow: {
    ...
    sub: "14 pozycji w tabelach PZP · 15–18 lat",
    cta: "Tabele",
  },
} as const
