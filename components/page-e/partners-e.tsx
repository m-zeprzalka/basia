...
const argumentMedia: { src: StaticImageData; alt: string; position: string }[] =
  [
    {
      src: monachiumZloto,
 ...
 */
export function PartnersE() {
  return (
    <Chapter id="partnerstwo" index={6} tone="light">
      <Frame className={chapterPadding}>
        <Reveal>
          <ChapterHead
            ...
            lead={partners.lead}
            aside={
              <ButtonLink size="2xl" href="#kontakt" className="max-sm:w-full">
                {partners.cta}
