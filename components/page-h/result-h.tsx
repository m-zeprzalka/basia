...
import { ReplayH } from "@/components/page-h/replay-h"
 ...
 * z dystansem 0,32 s do seniorskiego rekordu Polski. Fotofinisz przejmuje
 * rolę osi dystansu z wariantu E, więc rozdział nie powtarza tej samej
 * liczby dwa razy. Niżej — zdjęcie ze złotem i tablica finału.
 */
export function ResultH() {
  const { gap } = munich
